...
class KebutuhanPenggunaDetail  extends StatelessWidget {
  final KebutuhanModel kebutuhanpengguna;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: [
          Center(
              child: Text(
                kebutuhanpengguna.tokoKebutuhan,
            ...
            children: [
              Row(
                children: [
                  Flexible(
                    child: Text(
                      "Nama Kebutuhan: ${kebutuhanpengguna.namaKebutuhan}",
                      style: GoogleFonts.lato(
                        // textStyle: Theme.of(context).textTheme.headline3,
                        fontSize: 18,
              ...
              Row(
                children: [
                  Flexible(
                    child: Text(
                      "Harga Kebutuhan: ${kebutuhanpengguna.hargaKebutuhan}",
                      style: GoogleFonts.lato(
                        // textStyle: Theme.of(context).textTheme.headline3,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
              ...
              Row(
                children: [
                  Flexible(
                    child: Text(
                      "Deskripsi Kebutuhan: ${kebutuhanpengguna.deskripsiKebutuhan}",
                      style: GoogleFonts.lato(
                        // textStyle: Theme.of(context).textTheme.headline3,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
